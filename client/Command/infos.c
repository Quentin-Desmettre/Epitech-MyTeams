...
void client_users(client_t *client, UNUSED char **args)
{
...
void client_list(client_t *client, UNUSED char **args)
{
    void *packet = create_packet(LIST, NULL, NULL, 0);
    send_packet(packet, client->socketFd, true);
}

void client_info(client_t *client, UNUSED char **args)
{
    void *packet = create_packet(INFO, NULL, NULL, 0);
    send_packet(packet, client->socketFd, true);
}

void client_help(client_t *client, UNUSED char **args)
{
